...
```bash
cat draft-descriptions/<component>.description.yaml
```
...
```bash
git add draft-descriptions/<component>.description.yaml
git commit -m "feat(desc): enrich <component> — gaps + spec_notes"
```

- [ ] **P9. History 기록 (결정·정책 변경 시)**

`history/figma-description-history.md` 맨 아래에 추가:
```
...
**Files:**
- Create: `plan/2026-05-12-source-gaps-spec-notes-enrichment.md`

- [ ] 플랜 디렉토리 생성

```bash
mkdir -p /Users/jj.iee/Desktop/workspace/03_wf-figma-to-description/plan
```

- [ ] 이 플랜 파일을 plan/ 폴더에 복사

```bash
cp .claude/plans/hidden-napping-whistle.md plan/2026-05-12-source-gaps-spec-notes-enrichment.md
git add plan/2026-05-12-source-gaps-spec-notes-enrichment.md
git commit -m "docs: add enrichment plan to plan/"
```
...
**Files:** `draft-descriptions/tag.description.yaml`
...
**Files:** `draft-descriptions/tooltip.description.yaml`
...
**Files:** `draft-descriptions/loading-circular.description.yaml`
...
**Files:** `draft-descriptions/loading-dot.description.yaml`
...
**Files:** `draft-descriptions/snackbar.description.yaml`
...
**Files:** `draft-descriptions/toast.description.yaml`
...
**Files:** `draft-descriptions/title-header.description.yaml`
...
**Files:** `draft-descriptions/text-fields.description.yaml`
...
**Files:** `draft-descriptions/pagination-dot-v2.description.yaml`
...
**Files:** `draft-descriptions/skeleton.description.yaml`
...
**Files:** `draft-descriptions/avatar-group.description.yaml`
...
**Files:** `draft-descriptions/dropdown-box.description.yaml`
...
**Files:** `draft-descriptions/search.description.yaml`
...
**Files:** `draft-descriptions/thumbnail.description.yaml`
...
**Files:** `draft-descriptions/icon-button.description.yaml`
...
**Files:** `draft-descriptions/avatar.description.yaml`
...
**Files:** `draft-descriptions/bottom-navigation.description.yaml`
...
**Files:** `draft-descriptions/list-item-native.description.yaml`
...
**Files:** `draft-descriptions/list-item-web.description.yaml`
...
**Files:** `draft-descriptions/toggle-switch.description.yaml`
...
**Files:** `draft-descriptions/badge-dot.description.yaml`
...
**Files:** `draft-descriptions/badge-number.description.yaml`
...
**Files:** `draft-descriptions/checkbox.description.yaml`
...
**Files:** `draft-descriptions/radio.description.yaml`
...
**Files:** `draft-descriptions/scrim-overlay.description.yaml`
...
**Files:** `draft-descriptions/scrollbar.description.yaml`
...
**Files:** `draft-descriptions/text-button.description.yaml`
...
for f in draft-descriptions/*.description.yaml; do
...
```bash
# source_gaps 잔존 확인
grep -l "source_gaps:" draft-descriptions/*.description.yaml | xargs grep -A5 "source_gaps:" | grep -v "confirmed: true" | grep "  -"
```
