...
| --------------- | ----------------------------------------------------------------------- | --------------------------------------------- |
| Type            | 버튼 형태를 정의합니다.                                                           | Filled, Outlined-color, Outlined-gray, Ghost  |
| Mode            | Default를 선택하면 OS테마 환경에 따라 변경되고, Fixed를 선택하면 OS 테마 환경에 상관없이 다크테마로 보여집니다. | Default, Fixed                                |
| Size            | 버튼의 크기를 정의합니다.                                                          | XLarge, Large, Medium, Small, XSmall, XXSmall |
| State           | 버튼의 상태값을 정의합니다.                                                         | Default, Hover, Loading, Disabled             |
| Radius          | 버튼의 모서리 값을 정의합니다.                                                       | Square, Rounded                               |
| Option Leading  | 버튼 왼쪽 아이콘을 사용하거나, 숨겨둘 수 있습니다.                                           | On, Off                                       |
| Option Trailing | 버튼 오른쪽 아이콘을 사용하거나, 숨겨둘 수 있습니다.                                          | On, Off                                       |
...
| AOS: Light/Dark | 360 x 760 | Text Button / Filled / XLarge(52) | content area를 채움 | 하단 navigation area로부터 `system/size/padding/box/200` |
| AOS: Fixed | 360 x 760 | Text Button / Filled / XLarge(52) | content area를 채움 | 하단 navigation area로부터 `system/size/padding/box/200` |

## Guide

### Padding

| Size    | Button Height                       | Horizontal Padding            | Inner Gap Values                                           |
| ------- | ----------------------------------- | ----------------------------- | ---------------------------------------------------------- |
...
| XSmall  | `system/size/button-height/xsmall`  | `system/size/padding/box/150` | `system/size/padding/box/50`                               |
| XXSmall | `system/size/button-height/xxsmall` | `system/size/padding/box/100` | `system/size/padding/box/50`                               |
...
- token의 실제 light/dark 값은 `tokens.color.v1.0.json`을 기준으로 확인합니다.
