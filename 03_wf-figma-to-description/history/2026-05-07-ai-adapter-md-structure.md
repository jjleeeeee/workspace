...
duplicating long rule blocks. Duplicated rule files can drift when the
Description source of truth, validation gate, or MCP write policy changes.
...
- Do not change Figma Description workflow code, examples, drafts, or refs.
