| **주요 업무(4/30~5/6)** | **업무 성격** | **시작/완료** | **투입율** | **진행율** | **서비스 오픈** |
| -------- | -------- | -------- | -------- | -------- | -------- |
| **Click TF **{status:진행중|color:blue} - 피그마 파일 SoT화<br><br>  - 피그마 컴포넌트 별 do/don't 정리<br>  - 피그마 컴포넌트 디스크립션에 yaml 정보 입력(do/don't 포함) 자동화<br>  - 컴포넌트 URL과 컴포넌트 디스크립션 만으로 React 컴포넌트 구현 테스트 (35개 중 29개 테스트 진행) | {status:SUSTAINING} | 4/23~ | <span style="color: #ff5630">2.0</span> | 15% | - |
| **CDS **{status:진행중|color:blue} - CDS 사용성 개선<br><br>  - 인터뷰 진행 | {status:SUSTAINING} | 5/6~ | <span style="color: #ff5630">1.0</span> | - | - |
| **휴일**- 5/1(근로자의날), 5/5(어린이날) |  | 5/1, 5/5 | <span style="color: #ff5630">2.0</span> |  |  |
...
투입율 <span style="color: #bf2600">2.0</span> | 진행율 <span style="color: #ff5630">15%</span> | 디자인: 김선영C 님, 전지영님, 이정주 | 개발: 임경택 님, 김영민 님, 김유석 님, 한지훈 님
