...
- Treat `PLAYBOOK.md` as the short contract and `workflow/` as the detailed
  procedure.
- Do not overwrite canonical `../chord-design-system/tokens/` until generated
...
- Regenerate `../chord-design-system/tokens/{color,size,typography,typography.semantic}.json`.
- Validate token catalog shape and checklist constraints.
